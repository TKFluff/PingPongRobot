...
#define BEACON_DET            AD_PORTV7
#define TRACK_WIRE_DET        AD_PORTV8
#define FL_TAPE_SENS          AD_PORTW8
#define FR_TAPE_SENS          AD_PORTW7
#define BC_TAPE_SENS          AD_PORTV4
#define LEFT_BALL_TAPE_SENS   AD_PORTV5
//#define RIGHT_BALL_TAPE_SENS  AD_PORTV6
