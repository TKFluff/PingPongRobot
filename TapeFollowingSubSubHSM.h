...
#ifndef TAPE_FOLLOWING_SUB_SUB_HSM_H  // <- This should be changed to your own guard on both
#define TAPE_FOLLOWING_SUB_SUB_HSM_H  //    of these lines
...
#endif /* TAPE_FOLLOWING_SUB_SUB_HSM_H */
