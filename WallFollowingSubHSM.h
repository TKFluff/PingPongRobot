...
#ifndef WALL_FOLLOWING_SUB_HSM_H  // <- This should be changed to your own guard on both
#define WALL_FOLLOWING_SUB_HSM_H  //    of these lines
...
#endif /* WALL_FOLLOWING_SUB_HSM_H */
