/*
 * File: FindingCorrectHoleSubHSM.h
...
#ifndef FINDING_CORRECT_HOLE_SUB_HSM_H  // <- This should be changed to your own guard on both
#define FINDING_CORRECT_HOLE_SUB_HSM_H //    of these lines
...
#endif /* FINDING_CORRECT_HOLE_SUB_HSM_H */
