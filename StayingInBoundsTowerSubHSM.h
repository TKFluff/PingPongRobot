/*
 * File: StayingInBoundsTowerSubHSM.h
...
#ifndef StayingInBoundsTowerSubHSM_H  // <- This should be changed to your own guard on both
#define StayingInBoundsTowerSubHSM_H  //    of these lines
...
#endif /* StayingInBoundsTowerSubHSM_H */
